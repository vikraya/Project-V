...
class FoodsCategoriesPage extends StatefulWidget {
  const FoodsCategoriesPage({super.key});

  @override
  State<FoodsCategoriesPage> createState() => _FoodsCategoriesPageState();
}

class _FoodsCategoriesPageState extends State<FoodsCategoriesPage> {
  @override
  Widget build(BuildContext context) {
    return FoodsCategoriesListGrid();
  }
}

// living essentails categories page
class FoodsCategoriesListGrid extends StatefulWidget {
  const FoodsCategoriesListGrid({super.key});

  @override
  State<FoodsCategoriesListGrid> createState() =>
      _FoodsCategoriesListGridState();
}

class _FoodsCategoriesListGridState extends State<FoodsCategoriesListGrid> {
                  ...
                  children: List.generate(
                      ...
                      (index) => InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(CustomImagesfoods[index]),
                                  fit: BoxFit.fill,
                                ),
                                borderRadius: BorderRadius.circular(30),
                              ),
...
Widget AppBarFS(BuildContext context) {
  double height = MediaQuery.of(context).size.height;
  double width = MediaQuery.of(context).size.width;
  return AppBar(
    toolbarHeight: 50,
    ...
    flexibleSpace: Container(
      decoration: BoxDecoration(
        ...
        gradient: AppColors.AppBarColorF,
      ),
    ),
  );
}
